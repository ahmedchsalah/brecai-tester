...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description: 'Simulate calling FastAPI /extract. In a real environment, this extracts patches from the WSI and sends them to the AI service to generate a .pt feature file.',
        pathParams: [{ key: 'id', example: '1' }]
      },
      ...
      { id: 'doc-predictions-status', method: 'GET', path: '/doctor/predictions/:id/status', label: 'Prediction Status', description: 'Poll prediction job status.', pathParams: [{ key: 'id', example: '1' }] },
      {
        ...
        defaultBody: { examination_id: 1, wsi_upload_id: null },
      },
